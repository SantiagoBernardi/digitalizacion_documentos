...
export default function Upload() {
  ...
  async function handleUpload() {
    ...
    const result = await uploadFileAndSignature({ file, signature, onProgress: setUploadProgress })
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="w-full max-w-lg  shadow-sm border border-gray-200 rounded-md p-6 space-y-6 bg-white">
